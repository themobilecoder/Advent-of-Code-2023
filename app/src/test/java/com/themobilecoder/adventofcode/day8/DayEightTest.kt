...
class DayEightTest {
    ...
    @Test
    fun shouldSolveDay8Part1() {
        assertEquals(
            2,
            dayEight.solveDayEightPartOne(TEST_INPUT_1)
        )
        assertEquals(
            6,
            dayEight.solveDayEightPartOne(TEST_INPUT_2)
        )
        assertEquals(
            19783,
            dayEight.solveDayEightPartOne(ACTUAL_INPUT)
        )
    }

    @Test
    fun shouldSolveDay8Part2() {
        assertEquals(
            6L,
            dayEight.solveDayEightPartTwo(TEST_INPUT_3)
        )
        assertEquals(
            9177460370549,
            dayEight.solveDayEightPartTwo(ACTUAL_INPUT)
        )
    }
