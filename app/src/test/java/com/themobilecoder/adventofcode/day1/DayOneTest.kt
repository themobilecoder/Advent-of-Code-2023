...
class DayOneTest {
    ...
    @Test
    fun `should sum up first and last digit numbers`() {
        assertEquals(142, dayOne.solveDayOnePartOne(DAY_1_PART_1_TEST_INPUT_1))
        assertEquals(55834, dayOne.solveDayOnePartOne(DAY_1_PART_1_INPUT))
    }

    @Test
    fun `should solve DayTwo`() {
        assertEquals(281, dayOne.solveDayOnePartTwo(DAY_1_PART_2_TEST_INPUT_1))
        assertEquals(29, dayOne.solveDayOnePartTwo(DAY_1_PART_2_TEST_INPUT_2))
        assertEquals(53221, dayOne.solveDayOnePartTwo(PART_2_ACTUAL_INPUT))
    }

    companion object {
        private val DAY_1_PART_1_TEST_INPUT_1 = """
            1abc2
            pqr3stu8vwx
            a1b2c3d4e5f
            treb7uchet
        """.trimIndent()
        private val DAY_1_PART_1_INPUT = """
        29lzrxseven
        9nnqljsixkzphvtmtr
    ...
    private val DAY_1_PART_2_TEST_INPUT_1 = """
            two1nine
            eightwothree
            abcone2threexyz
            xtwone3four
            ...
            7pqrstsixteen
        """.trimIndent()
    private val DAY_1_PART_2_TEST_INPUT_2 = """
            two1nine
        """.trimIndent()

    private val PART_2_ACTUAL_INPUT = """
            29lzrxseven
            9nnqljsixkzphvtmtr
            five73kskpfgbkcltwoccvf
            fiveq7
