...
class DayTwoTest {
    ...
    @Test
    fun `should get correct sum for part 1`() {
        assertEquals(3, dayTwo.solveDayTwoPartOne(PART_1_TEST_INPUT_1))
        assertEquals(2, dayTwo.solveDayTwoPartOne(PART_1_TEST_INPUT_2))
        assertEquals(8, dayTwo.solveDayTwoPartOne(PART_1_TEST_INPUT_3))
        assertEquals(2156, dayTwo.solveDayTwoPartOne(DAY_2_PART_1_ACTUAL_INPUT))
    }

    @Test
    fun `should get correct sum for part 2`() {
        assertEquals(48, dayTwo.solveDayTwoPartTwo(PART_2_TEST_INPUT_1))
        assertEquals(2286, dayTwo.solveDayTwoPartTwo(PART_2_TEST_INPUT_2))
        assertEquals(66909, dayTwo.solveDayTwoPartTwo(DAY_2_PART_2_ACTUAL_INPUT))
    }

    companion object {
        private val PART_1_TEST_INPUT_1 = """
            Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
            Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
        """.trimIndent()
        private val PART_1_TEST_INPUT_2 = """
            Game 1: 3 blue, 4 red; 1 red, 202 green, 6 blue; 2 green
            Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
        """.trimIndent()
        private val PART_1_TEST_INPUT_3 = """
Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green
        ...
        private val PART_2_TEST_INPUT_2 = """
            Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
            Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
            Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
            Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
        ...
        private val PART_2_TEST_INPUT_1 = """
            Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
        """.trimIndent()

        private val DAY_2_PART_1_ACTUAL_INPUT = """
        ...
        private val DAY_2_PART_2_ACTUAL_INPUT = """
            Game 1: 4 blue, 4 red, 16 green; 14 green, 5 red; 1 blue, 3 red, 5 green
            Game 2: 3 green, 8 red, 1 blue; 5 green, 6 blue; 4 green, 4 blue, 10 red; 2 green, 6 red, 4 blue; 8 red, 11 blue, 4 green; 10 red, 10 blue
            Game 3: 7 blue, 2 green; 9 blue, 2 green, 4 red; 5 blue, 2 red; 1 red, 1 green, 10 blue; 1 green, 5 blue, 1 red
            Game 4: 5 green, 4 blue, 15 red; 1 green, 5 blue, 2 red; 14 red, 3 blue, 2 green; 6 red, 12 green, 1 blue; 1 blue, 6 green, 16 red
